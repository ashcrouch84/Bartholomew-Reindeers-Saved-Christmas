...
<html>
	...
	<body>
		...
		<p><center><font size = "6" color="white">Reindeer 2 Information</font></center></p>
	...
	<center><form action="Reindeer2.php" method=post enctype='multipart/form-data'></center>
							...
							while ($i < $count+1)
								...
								while ($i < $count)
									...
									if ($hiddenX[$familyCount-1] == "Hidden")
										{
									?>
										<form action="Reindeer2.php" method=post enctype='multipart/form-data'>
												<a>
													<span></span>
													<span></span>
													<span></span>
